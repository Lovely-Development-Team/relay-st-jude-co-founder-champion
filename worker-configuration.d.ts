/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 08d6b10738f7e965a39503d4b001c120)
// Runtime types generated with workerd@1.20260903.1 2026-06-16 
interface __BaseEnv_Env {
	RELAY_FOR_ST_JUDE: KVNamespace;
	WIDGET_PUSH_TOKENS: D1Database;
	ST_JUDE_SCOREBOARD_URL: "https://relay-scoreboard-v2.prod.experience.stjude.org/api/scoreboard";
	APNS_BUNDLE_ID: "dev.snailedit.stjude";
	APNS_LIVE_ACTIVITY_ATTRIBUTES_TYPE: "ScoreAttributes";
	LIVE_ACTIVITY_START_TIME: "2026-10-02T16:00:00Z";
	LIVE_ACTIVITY_END_TIME: "2026-10-03T16:00:00Z";
	LIVE_ACTIVITY_RESTART_INTERVAL_HOURS: "7";
	ST_JUDE_SCOREBOARD_KEY: string;
	PUSH_TOKEN_UPDATE_KEY: string;
	APNS_AUTH_KEY_SANDBOX: string;
	APNS_KEY_ID_SANDBOX: string;
	APNS_AUTH_KEY_PRODUCTION: string;
	APNS_KEY_ID_PRODUCTION: string;
	APNS_TEAM_ID: string;
}
